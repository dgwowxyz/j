...
local Library do
    ...
    Library = {
        ...
        Theme = {
            ["Background"] = FromHex("#0f0f10"),
            ["Inline"] = FromHex("#141415"),
            ["Page Background"] = FromHex("#1a1a1c"),
            ["Border"] = FromHex("#080808"),
            ["Outline"] = FromHex("#2a2a2d"),
            ["Accent"] = FromHex("#ffd24a"),
            ["Element"] = FromHex("#202022"),
            ["Hovered Element"] = FromHex("#2a2a2d"),
            ["Text"] = FromHex("#ffffff"),
